export const MODULE_ID = "pf2e-ex-token-pack-character-gallery";
export const TAKEOVER_ID = "pf2e-ex-token-pack";

/**
 * Определяет, какой ID модуля использовать.
 * Если модуль 'pf2e-ex-token-pack' активен, используется его ID.
